...
description: |
  It's compatible with dplyr 0.8.5 and R back to 3.4; but update ASAP!
author:
  - name: Mauro Lepore
...
r2dii.match 0.0.2 is now on CRAN. r2dii.match provides tools to match financial portfolios with climate data. This release is compatible with with dplyr v0.8.5, and with R back to v3.4; but you should update both as soon as possible.
...
[All changes in this version are internal](https://github.com/2DegreesInvesting/r2dii.match/releases/tag/v0.0.2). In general, internal changes do not affect users short term; but in the long term, they might. Here I explain how internal work in 
R packages may eventually impact you; and I encourage you to update R and R packages to keep things working as you expect.
