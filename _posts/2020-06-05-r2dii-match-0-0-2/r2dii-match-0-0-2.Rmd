...
You should update your R packages as often as it is possible and convenient -- maybe weekly. This helps you keep up with the rapid change of popular packages. For example, we now support dplyr v0.8.5 but you should update to dplyr v1.0.0 ASAP. [Some features of v0.8.5 have been superseded in v1.0.0](https://dplyr.tidyverse.org/news/index.html#superseded). To stay within best practices, we may enforce v1.0.0 any time.
