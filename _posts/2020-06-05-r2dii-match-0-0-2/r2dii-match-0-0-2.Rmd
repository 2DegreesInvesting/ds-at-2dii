...
r2dii.match 0.0.2 is now on CRAN. r2dii.match provides tools to match financial portfolios with climate data. This release is compatible with with dplyr v0.8.5, and with R back to v3.4; but you should get current ASAP.
